                ...
                <section id="cta">
                    <div class="row d-flex justify-content-center mt-3 mb-3">
                        <div class="col-11 col-md-10 col-lg-6 p-2 text-center">
                            <h1 class="h1-cta inter-bold">Erro de conexão</h1>
                            <p class="p-cta inter-regular cinza">Não conseguimos estabelecer conexão com o banco de dados. Tente novamente.</p> 
