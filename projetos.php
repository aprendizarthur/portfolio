...
<html lang="pt-br">
    <head>
        ...
        <link rel="canonical" href="developerarthurvieira.com.br/projetos">
        <!-- Meta tags -->
        <meta charset="UTF-8">
        ...
        <meta name="description" content="Explore os meus projetos que incluem: Sites institucionais com SEO, Criação de Conteúdo para Mídias Sociais e Projetos Pessoais.">
                ...
                <section id="pesquisa">
                    <div class="row d-flex justify-content-center text-center my-3">
                        <div class="col-11 col-md-10 col-lg-10 p-4 text-center bg-preto" style="border-radius: 24px;">
                            <h1 class="h1-cta inter-bold text-light mb-4">Pesquise projetos</h1>
                            ...
                            <div id="categorias" class="d-none d-md-block">
                                <a class="poppins-regular cinza d-inline mx-2" href="#projeto-pessoal">Projetos pessoais</a>
                                <a class="poppins-regular cinza d-inline mx-2" href="#projeto-profissional">Projetos profissionais</a>
                                <a class="poppins-regular cinza d-inline mx-2" href="#projeto-extensao">Projetos extensão</a>
                            </div>
                        </div>
